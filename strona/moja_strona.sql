...
--
-- Host: 127.0.0.1
-- Generation Time: Sty 17, 2025 at 05:26 AM
...
(36, 12, 4, 5, '2025-01-02 04:22:58'),
(37, 13, 7, 8, '2025-01-17 04:23:18');
...
INSERT INTO `produkty` (`id`, `tytul`, `opis`, `data_utworzenia`, `data_modyfikacji`, `data_wygasniecia`, `cena_netto`, `podatek_vat`, `ilosc_magazyn`, `status_dostepnosci`, `kategoria_id`, `zdjecie`) VALUES
(4, 'Szybcy i Wściekli', 'Film akcji pełen pościgów i adrenaliny.', '2025-01-13 04:09:03', '2025-01-16 21:51:13', '2025-01-03 00:00:00', 46.00, 23.00, 20, 1, 5, 'uploads/szybcyiwscielki.jpg'),
(5, 'Casino Royale', 'Klasyczny Bond z dużą dawką akcji.', '2025-01-13 04:09:03', '2025-01-16 21:50:58', '2025-03-16 00:00:00', 50.00, 23.00, 15, 1, 5, 'uploads/CasinoRoyale.jpg'),
(6, 'Avengers', 'Film o drużynie superbohaterów walczących z zagrożeniem.', '2025-01-13 04:09:18', '2025-01-16 21:50:38', '2025-12-31 00:00:00', 60.00, 23.00, 10, 1, 6, 'uploads/avengers.jpg'),
(7, 'Batman: Początek', 'Początki Batmana w Gotham City.', '2025-01-13 04:09:18', '2025-01-16 21:50:13', '2025-03-13 00:00:00', 55.00, 23.00, 8, 1, 6, 'uploads/batmanpoczatek.jpg'),
(10, 'Fargo', 'Historia kryminalna z elementami czarnego humoru.', '2025-01-13 04:09:53', '2025-01-16 21:49:44', '2027-12-31 00:00:00', 48.00, 23.00, 7, 1, 8, 'uploads/fargo.jpg'),
(12, 'Blade Runner', 'Klasyczny film o dystopijnej przyszłości.', '2025-01-13 04:10:07', '2025-01-16 21:49:04', '2025-12-12 00:00:00', 55.00, 23.00, 10, 1, 11, 'uploads/bladerunner.jpg'),
(13, 'Mad Max: Fury Road', 'Postapokaliptyczny świat pełen chaosu.', '2025-01-13 04:10:07', '2025-01-16 21:48:44', '2025-11-11 00:00:00', 58.00, 23.00, 8, 1, 11, 'uploads/madmax.jpg'),
(15, 'Interstellar', 'Wyprawa kosmiczna w poszukiwaniu nowego domu.', '2025-01-13 04:10:16', '2025-01-16 22:27:44', '2014-03-15 00:00:00', 62.00, 23.00, 12, 1, 13, 'uploads/interstellar.jpg');
...
(12, 'test@gmail.com', '$2y$10$HWSWx4/8cVRxKZZb66ucjen2pg5mOsWf946dizG8dFBpKfrqkIC0.', '2025-01-17 04:22:17'),
(13, 'test2@gmail.com', '$2y$10$rQR4e4Y.gUVDkKRN13aCXOdxuOK7mxZNj53/cByZg65pPT3XDPgVC', '2025-01-17 04:22:33');
...
ALTER TABLE `koszyk`
  ...
  ADD KEY `koszyk_ibfk_2` (`id_uzytkownika`);
...
ALTER TABLE `koszyk`
  ...
  ADD CONSTRAINT `koszyk_ibfk_2` FOREIGN KEY (`id_uzytkownika`) REFERENCES `users` (`id`) ON DELETE CASCADE;
