...
function DodajNowaPodstrone() {
    ...
    echo '<form method="post" action="' . htmlspecialchars($_SERVER['REQUEST_URI']) . '", class="add-page-form">
        ...
        <input type="text" id="page-title" name="page_title" class="form-input">
        ...
        <input type="submit" name="zapisz_dodaj_podstrone" class="form-button" value="Zapisz nową podstronę">
    </form>';
    echo '</div>';
}
