...
function DodajProdukt() {
    ...
    echo '<form method="post" action="" enctype="multipart/form-data">
        ...
        <input type="text" id="tytul" name="tytul" class="input-field" required>

        <label for="opis">Opis:</label>
        <textarea id="opis" name="opis" class="textarea-field" required></textarea>

        <label for="data_wygasniecia">Data wygaśnięcia:</label>
        <input type="date" id="data_wygasniecia" name="data_wygasniecia" class="input-field">

        <label for="cena">Cena netto:</label>
        <input type="number" id="cena" name="cena" class="input-field" step="0.01" required>

        <label for="vat">VAT (%):</label>
        <input type="number" id="vat" name="vat" class="input-field" step="0.01" value="23.00" readonly>

        <label for="ilosc">Ilość w magazynie:</label>
        <input type="number" id="ilosc" name="ilosc" class="input-field" required>
        ...
        <input type="number" id="kategoria" name="kategoria" class="input-field" required>

        <label for="zdjecie">Zdjęcie:</label>
        <input type="file" id="zdjecie" name="zdjecie" class="file-input" accept="image/*" required>
